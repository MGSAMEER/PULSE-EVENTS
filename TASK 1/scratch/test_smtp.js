...
// Load environment variables directly from the backend config
    ...
    return transporter.sendMail({
      ...
      html: `
        <div style="font-family: Inter, sans-serif; text-align: center; padding: 50px; background: #0a0a0a; color: #fff; border-radius: 20px; border: 1px solid #333;">
            ...
            <p style="color: rgba(255,255,255,0.7); font-size: 16px;">This confirms your backend NodeMailer transport is successfully authenticated and functioning properly.</p>
